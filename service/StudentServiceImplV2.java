...
// StudentServiceImplV1에 정의된 필드변수, method를 상속받아서 작성하는 클래스
...
public class StudentServiceImplV2 extends StudentServiceImplV1{
	...
	public StudentServiceImplV2() {
		String studentFile = "src/com/biz/student/exec/student_list.txt"; //타이핑 노노!! Copy Qualified Name으로!!
	...
	// StudentServiceImplV1에 선언된 studentList는 protected로 되어있기 때문에
	// 그대로 접근이 가능하고
	// StudentServiceImplV1의 생성자에서 생성(초기화)가 되어있기 때문에
	// StudentServiceImplV2에서는 그냥 접근하여 읽기, 쓰기를 수행하면 된다.
	
	
	// V1에서 구현된 studentList() method를 다시 새롭게 구현하겠다.
	// List를 Console에 보여주는 방식
