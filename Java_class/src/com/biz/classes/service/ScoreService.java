...
public class ScoreService {
	...
	public int sum(int kor, int eng, int math, int music, int art, int science) {
		int sum = kor + eng + math + music + art + science;
		return sum;
	}
