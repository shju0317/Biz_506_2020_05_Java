...
public class ClassEx_12_2 {
	public static void main(String[] args) {
		...
		for(int i=0;i<bankList.length;i++) {
			...
			bankList[i].setStrDate("2020-05-0"+(i+1));
		}
		...
		double num3 = 0.0;
		boolean bYes = false;
		char char1 = 'c'; // charater형 변수 char1를 선언하고 문자 c를 저장
		
		// String(문자열)형 변수는
		// 변수처럼 사용하지만 실제로는 일반변수와 달리
		// String클래스로 만든 String형 인스턴스라고 해야한다.
		String strName = "이태민";
		// String strName = new String("이태민");
		...
		// BankServiceV2 클래스 내에 정의된 bankList() method 내의
		// 코드들이 순서대로 실행된다.
