...
public class varBoolean_04 {
	public static void main(String[] args) {
		 ...
		 *  알 수 없는 어떤 값이 저장되어 있을 수도 있다.
		 *  
		 *  때문에 변수는 어떠한 값을 할당, 저장, 대입 하기 전가지는
		 *  읽기를 할 수 없다.
		 *  
		 ...
		 */
		String str1 = "대한민국"; // String : 클래스형 키워드
		/*
		 * Random type의 rnd 변수를 선언하는 명령
		 * 기본적으로 제공되지 않는 필요에 따라 JDK를 import해서
