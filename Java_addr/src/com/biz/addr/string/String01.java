...
public class String01 {
	public static void main(String[] args) {
		...
		System.out.println(str3==str4); // false(간혹 true)
		
		/*
		 * 문자열형 변수
		 * 기본형 변수와 같은 방식으로 사용으ㅏㄹ 하지만 태생은 클래스이다.
		 * 즉 문자열형 변수는 String 클래스의 객체(인스턴스)이다.
		 * 따라서 String 클래스에 정의된 다양한 method들을 사용할 수 있다는 것이다.
		 * 그 중 가장 많이 사용하는 method가 바로 문자열변수의 값을 비교하는 equals() method 이다.
		 * 
		 * equals()
